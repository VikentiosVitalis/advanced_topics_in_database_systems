...
# Join crime data with reverse geocoding data using shuffle hash join
crime_2015 = crime_2015.hint("shuffle_hash").join(revgecoding, ['LAT', 'LON'], 'left_outer')
...
selected_crimes = crime_2015.hint("shuffle_hash").join(selected_zip_codes, crime_2015.ZIPcode == selected_zip_codes['Zip Code'])
