...
# Join crime data with reverse geocoding data
...
selected_crimes = crime_2015.join(selected_zip_codes, crime_2015.ZIPcode == selected_zip_codes['Zip Code'])
...
# Apply user defined function to victim descent column
