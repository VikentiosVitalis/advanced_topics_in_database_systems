...
# Join crime data with reverse geocoding data using broadcast join
crime_2015 = crime_2015.join(broadcast(revgecoding), ['LAT', 'LON'], 'left_outer')
...
selected_crimes = crime_2015.join(broadcast(selected_zip_codes), crime_2015.ZIPcode == selected_zip_codes['Zip Code'])
