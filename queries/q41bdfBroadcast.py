...
# Join dataframes with broadcast
weapon_crimes = weapon_crimes.join(broadcast(police_stations), upper(weapon_crimes['AREA NAME']) == police_stations['DIVISION'], 'left_outer')

# Physical plan
weapon_crimes.explain()
